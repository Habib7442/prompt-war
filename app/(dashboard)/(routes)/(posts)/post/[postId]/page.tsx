...
import { fetchSinglePost } from "@/provider/redux/postsSlice";
...
const SinglePost = ({ params }: any) => {
  ...
  useEffect(() => {
    if (postId) {
      dispatch(fetchSinglePost(postId as string));
    }
  }, [dispatch, postId]);
  return (
    <>
      {singlePost && (
        <PostMetaTags
          ...
          description={singlePost.prompt}
          imageUrl={singlePost.thumbnail}
          url={`${
          ...
          {singlePost && (
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <p className="leading-relaxed text-blue-200 font-bold">
                  {singlePost.prompt}
                </p>
              </div>
            </div>
